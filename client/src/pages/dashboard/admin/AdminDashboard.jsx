...
export default function AdminDashboard() {
  ...
  return (
    <div className="p-6 min-h-screen bg-gray-50">
      ...
      {mensaje && (
        <div className="bg-red-100 text-red-700 p-3 rounded mb-4">{mensaje}</div>
      )}
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="bg-gradient-to-br from-teal-500 to-teal-600 text-white p-6 rounded-2xl shadow-md">
          ...
          <div className="bg-gradient-to-br from-sky-500 to-sky-600 text-white p-6 rounded-2xl shadow-md">
          ...
          <div className="bg-gradient-to-br from-amber-500 to-amber-600 text-white p-6 rounded-2xl shadow-md">
          ...
          <div className="bg-gradient-to-br from-rose-500 to-rose-600 text-white p-6 rounded-2xl shadow-md">
